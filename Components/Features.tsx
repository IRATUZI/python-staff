    ...
    overflow-hidden bg-feature-bg bg-center bg-no-repeat py-24">
      ...
      <div className="z-20 flex w-full flex-col  lg:w-[60%] ">
        <div className="relative ">
          ...
          width={45}
          height={45}
          className='absolute left-[-5px] top-[-50px] lg:w-[58px]'
          />
          <h2 className='bold-40 lg:bold-64'>Our Features</h2>
        </div>
        <ul className="mt-10 gap-10  md:grid md:grid-cols-2 lg:mt-20 lg:gap-20 lg:grid">
  ...
  return(
    <li className="flex w-full flex-1 flex-col items-start">
      <div className="rounded-full p-4 lg:p-7 bg-green-50">
        ...
        <p className=" regular-16 mt-5 mb-8 bg-white/80 text-gray-30 lg:mt-[30px] lg:bg-none">{description}</p>
