    ...
    <div className={`h-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          <span className=" flex -space-x-4 ovefleow-hidden">
            {PEOPLE_URL.map((url)=>(
              <Image
              src={url}
              key={url}
...
relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
  ...
  <div className="flexEnd px-6 mt-10 lg:-mt-60 lg:mr-6">
    <div className=" bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[743px] xl:rounded-5xl xl:px-7 xl:py-9 relative w-full overflow-hidden rounded-3xl">
