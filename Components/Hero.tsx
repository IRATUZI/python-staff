...
<section className=' max-container padding-container flex flex-col gap-20 py-10 md:gap-28 lg:py-20 xl:flex-row'>
    ...
    <div className=" relative z-20 flex flex-1 flex-col xl:w-1/3">
        ...
        width ={50}
        height ={50}
        className =" left-[5px] w-10 lg:w-[50px]"
        />
        <h1 className="bold-52 lg:bold-88">Travelo Truno Camp Area</h1>
        ...
        <div className="my-11 flex-wrap gap-5">
            ...
            <p className="bold-16 lg:bold-20 text-blue-10">
                198k
    ...
    <div className="flex-1 relative flex items-start">
        <div className="relative flex z-20  w-[270px] flex-col  gap-12 rounded-3xl bg-green-90 px-7 py-8">
